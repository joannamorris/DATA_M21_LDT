...
erp_2A <- read_csv("bf_m21_ldt_mea_200300_050050_1_AB.csv")
erp_2B <- read_csv("bf_m21_ldt_mea_200300_050050_1_BA.csv")
erp_4A <- read_csv("bf_m21_ldt_mea_300500_050050_1_AB.csv")
erp_4B <- read_csv("bf_m21_ldt_mea_300500_050050_1_BA.csv")
```
...
rt_words_frq2 <- rt_words_frq |> select(SubjID, z_vcb, z_spl, z_art, Dim.1, Dim.2, correct, response_time,
                                        trial_type, target, word_trig, cond_trig, Base,affix, FS, BF, LogBF, 
...
rt_nwords_frq2 <- rt_nwords_frq |> select(SubjID, z_vcb, z_spl, z_art, Dim.1, Dim.2, correct, response_time,
                                        trial_type, complexity, target, ItemID, word_trig, cond_trig, base,affix, FS, BF, LogBF, 
                                        BaseLength, WholeFormLength, List)
```
...
erp_BF_i <- erp_BF |>
  ...
  mutate(binlabel = str_replace(binlabel, "_Base_Frequency", "")) |>
  select(-mlabel)
