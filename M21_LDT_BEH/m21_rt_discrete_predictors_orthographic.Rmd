...
|                        Effect|       df |      F |p.value|
|------------------------------|----------|--------|-------|
|                Base_Frequency| 1, 92.45 |10.29 **|   .002|
|                   Family_Size| 1, 92.44 | 9.41 **|   .003|
...
|                     Effect|          df |        F |p.value |
|---------------------------|-------------|----------|--------|
|                 Complexity|  1, 4529.58 |124.76 ***|   <.001|
|   Orthographic_Sensitivity|  1,   63.59 |  5.37   *|    .024|
...
|   Orthographic_Sensitivity|  1,   63.60 |  5.32   *|    .024|
...
- Orthographic Sensitivity (F = 5.32, p = .024): same direction as before.
...
```{r nwords_bf_interaction_contrasts}
...
confint(contrast(emmeans(m3, ~ Base_Frequency | Complexity), "pairwise"))
...
| Orthographic Sensitivity | High > Low (faster RTs overall) | Readers with higher orthographic sensitivity are generally more efficient. |
...
```{r nwords_bf_interaction_plots, fig.height=3, fig.width=8}
