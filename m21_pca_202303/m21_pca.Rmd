...
art_vcb_spl_raw_1 <- na.omit(langdat_1_202410) |> select(Vocabulary, Spelling, ART)
art_vcb_spl_z_1 <- na.omit(langdat_1_202410) |> select( z_Vocabulary, z_Spelling, z_ART) 
