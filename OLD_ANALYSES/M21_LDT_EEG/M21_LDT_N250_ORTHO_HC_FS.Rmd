...
p3 <- emmip(anova_model_n250_nonwords, family_size  ~ complexity | Orthographic_Sensitivity) + my_style
p4 <- emmip(anova_model_n250_nonwords, complexity  ~ family_size | Orthographic_Sensitivity) + my_style
