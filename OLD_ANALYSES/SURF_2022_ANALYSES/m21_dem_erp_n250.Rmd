...
4. Then we join the demographic and erp data files. In contrast to what I said earlier, we will use the `inner_join` rather than the `full_join` function in order to eliminate rows with missing data.
