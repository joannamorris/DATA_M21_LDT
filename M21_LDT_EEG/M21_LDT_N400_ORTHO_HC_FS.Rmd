...
p3 <- emmip(anova_model_n400_nonwords, complexity ~ family_size)  + my_style
p4 <- emmip(anova_model_n400_nonwords, family_size ~ complexity)  + my_style
plot_grid(p3, p4, ncol = 3)
```
