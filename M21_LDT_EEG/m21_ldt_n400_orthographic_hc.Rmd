...
confint(contrast(emm1,method = "pairwise", by = "complexity", adjust = "holm"))

# Simple effects of base_freq at each level of family_size
contrast(emm1, method = "pairwise", by = "family_size", adjust = "holm")
confint(contrast(emm1, method = "pairwise", by = "family_size", adjust = "holm"))

eff_size(emm1, sigma = sigma(m1), edf = df.residual(m1))
...
confint(contrast(emmeans(m1, ~ family_size | complexity), "pairwise"))
