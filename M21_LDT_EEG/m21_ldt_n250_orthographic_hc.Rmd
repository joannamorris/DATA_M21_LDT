---
title: "M21 LDT ERP HC ORTHOGRAPIC SENSITIVITY N250"
...
(emm2 <- emmeans(anova_model_n250_nonwords, ~ Orthographic_Sensitivity * family_size * complexity))
...
p3 <- ggplot(emm2_df,
  ...
  labs(x = "Complexity", y = "Estimated N250 amplitude",
       color = "Family Size",
       title =  "Family Size × Complexity × Orthographic Sensitivity") +
  scale_color_custom() +
  scale_fill_custom()
...
p4 <- ggplot(emm2_df,
  ...
  labs(x = "Family Size", y = "Estimated N250 amplitude",
       color = "Complexity",
       title = "Complexity × Family Size × Orthographic Sensitivity") +
  scale_color_custom() +
  scale_fill_custom()
