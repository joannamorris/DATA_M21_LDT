...
# Simple effects of family_size at each level of complexity
# Simple effects of complexity at each level of family_size
keep3 <- c("High Orthographic Large Complex - High Orthographic Large Simple",
          "High Orthographic Small Complex - High Orthographic Small Simple",
          "Low Orthographic Large Complex - Low Orthographic Large Simple",
          "Low Orthographic Small Complex - Low Orthographic Small Simple",
          "High Orthographic Large Complex - High Orthographic Small Complex",
          "High Orthographic Large Simple - High Orthographic Small Simple",
          "Low Orthographic Large Complex - Low Orthographic Small Complex",
          "Low Orthographic Large Simple - Low Orthographic Small Simple",
          ...
          "High Orthographic Large Simple - Low Orthographic Small Simple",
...
<br>  
```{r, fig.width=3.5}
emmip(anova_model_n250_nonwords, Orthographic_Sensitivity ~ complexity)
```
...
<br>  
```{r}
emmip(anova_model_n250_nonwords, Orthographic_Sensitivity ~ complexity | family_size)
```
