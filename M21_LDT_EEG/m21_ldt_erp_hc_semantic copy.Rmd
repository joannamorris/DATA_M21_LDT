...
selected_contrasts <- c("High Semantic Large Family High Base Frequency - High Semantic Small Family High Base Frequency",
...
emmeans_obj <- emmeans(anova_model_1a, 
                 pairwise ~ Semantic_Sensitivity * family_size * base_freq, 
                 adjust = "bonferroni", 
                 pbkrtest.limit = 6480)
(contrasts_df <- as.data.frame(emmeans_obj$contrasts))
selected_contrasts_df <- as.data.frame(emmeans_obj$contrasts[contrasts_df$contrast %in% selected_contrasts, ])

cohensd_1 <- as.data.frame(cohens_d(value ~ family_size,  data = subset(n250_words_b, Semantic_Sensitivity == "High Semantic" & base_freq == "High Base Frequency")))
cohensd_2 <- as.data.frame(cohens_d(value ~ base_freq, data = subset(n250_words_b, Semantic_Sensitivity == "High Semantic" & family_size == "Large Family")))
cohensd_3 <- as.data.frame(cohens_d(value ~ family_size,  data = subset(n250_words_b, Semantic_Sensitivity == "Low Semantic" & base_freq == "High Base Frequency")))
cohensd_4 <- as.data.frame(cohens_d(value ~ base_freq,  data = subset(n250_words_b, Semantic_Sensitivity == "Low Semantic" & family_size == "Large Family")))
cohensd_5 <- as.data.frame(cohens_d(value ~ base_freq, data = subset(n250_words_b, Semantic_Sensitivity == "High Semantic" & family_size == "Small Family")))
cohensd_6 <- as.data.frame(cohens_d(value ~ base_freq, data = subset(n250_words_b, Semantic_Sensitivity == "Low Semantic" & family_size == "Small Family")))
cohensd_7 <- as.data.frame(cohens_d(value ~ family_size,  data = subset(n250_words_b, Semantic_Sensitivity == "High Semantic" & base_freq == "Low Base Frequency")))
...
cohensd_df <- bind_rows(cohensd_1, cohensd_2, cohensd_3, cohensd_4, cohensd_5, cohensd_6, cohensd_7, cohensd_8)
(sensitivity.familiarity.accuracy_contrasts <- bind_cols(selected_contrasts_df,cohensd))
(sensitivity.familiarity.accuracy_means_1 <- as.data.frame(emmeans_obj$emmeans))
...
|Semantic_Sensitivity:base_freq| 1, 2121|   4.36 * |    .037|2.05e-03 |
...
```{r}
# `Semantic_Sensitivity` x `base_freq`  interaction
...
emmeans_obj <- emmeans(anova_model_2a, pairwise ~ Semantic_Sensitivity * base_freq, adjust = "bonferroni", pbkrtest.limit = 6480)
...
cohensd_hi_basefrq <- as.data.frame(cohens_d(value ~ Semantic_Sensitivity,
                                          data = subset(n400_words_b, base_freq == "High Base Frequency")))
cohensd_lo_basefrq <- as.data.frame(cohens_d(value ~ Semantic_Sensitivity, 
                                             data = subset(n400_words_b, base_freq == "Low Base Frequency")))
cohensd_hi_orthosens <- as.data.frame(cohens_d(value ~ base_freq, 
                                            data = subset(n400_words_b, Semantic_Sensitivity == "High Orthographic")))
cohensd_lo_orthosens <- as.data.frame(cohens_d(value ~ base_freq,
                                           data = subset(n400_words_b, Semantic_Sensitivity == "Low Orthographic")))
...
reduced_model_int <- update(anova_model_1a,
  . ~ . - Semantic_Sensitivity:base_freq - Semantic_Sensitivity:family_size:base_freq)
anova(anova_model_1a, reduced_model_int)
