...
erp_2A <- read_csv(file.path(dir_path, "m21_ldt_mea_200300_050050_1_AB.csv"))
erp_2B <- read_csv(file.path(dir_path, "m21_ldt_mea_200300_050050_1_BA.csv"))
erp_4A <- read_csv(file.path(dir_path, "m21_ldt_mea_300500_050050_1_AB.csv"))
erp_4B <- read_csv(file.path(dir_path, "m21_ldt_mea_300500_050050_1_BA.csv"))
...
- At **High Base Frequency**:  `Large` vs. `Small` family → no difference (*p* = .87). Family size doesn’t matter when base frequency is high.

- Within **Small Family**: `High` vs. `Low` base frequency → not significant (*p* = .42). Small-family words are unaffected by base frequency.

- At **Low Base Frequency**: Large vs. Small family → significant difference (*p* = .017). Small-family words yield more negative amplitudes than large-family words, but only when base frequency is low.

- Within **Large Family**: High vs. Low base frequency → significant (*p* = .028). Large-family words show more negative amplitudes when their base frequency is high.
...
A three way interaction between
  ...
  - `Sensitivity × Family Size × Complexity`: significant (*t* = 4.58, *p* =.033).
...
keep2 <- c("High Semantic Large Complex - High Semantic Large Simple",
          "High Semantic Small Complex - High Semantic Small Simple",
          "Low Semantic Large Complex - Low Semantic Large Simple",
          "Low Semantic Small Complex - Low Semantic Small Simple",
          "High Semantic Large Complex - High Semantic Small Complex",
          "High Semantic Large Simple - High Semantic Small Simple",
          "Low Semantic Large Complex - Low Semantic Small Complex",
          "Low Semantic Large Simple - Low Semantic Small Simple",
          "High Semantic Large Complex - Low Semantic Large Complex",
          "High Semantic Small Complex - Low Semantic Small Complex",
          "High Semantic Large Simple - Low Semantic Small Simple",
...
p3 <- ggplot(emm2_df,
  ...
  labs(x = "Complexity", y = "Estimated N250 amplitude",
       color = "Family Size",
       title =  "Family Size × Complexity × Semantic Sensitivity") +
  scale_color_custom() +
  scale_fill_custom()
...
p4 <- ggplot(emm2_df,
  ...
  labs(x = "Family Size", y = "Estimated N250 amplitude",
       color = "Complexity",
       title = "Complexity × Family Size × Semantic Sensitivity") +
  scale_color_custom() +
  scale_fill_custom()
